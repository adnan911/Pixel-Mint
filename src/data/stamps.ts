...
export const PREMADE_STAMPS: Stamp[] = [
    ...
    // --- Icons & Symbols ---
    {
        ...
        height: 7,
        data: createGrid(7, 7, [
            { x: 0, y: 0, color: "#EF4444" }, { x: 1, y: 0, color: "#EF4444" }, { x: 5, y: 0, color: "#EF4444" }, { x: 6, y: 0, color: "#EF4444" },
            { x: 1, y: 1, color: "#EF4444" }, { x: 2, y: 1, color: "#EF4444" }, { x: 4, y: 1, color: "#EF4444" }, { x: 5, y: 1, color: "#EF4444" },
            { x: 2, y: 2, color: "#EF4444" }, { x: 3, y: 2, color: "#EF4444" }, { x: 4, y: 2, color: "#EF4444" },
            { x: 3, y: 3, color: "#EF4444" },
            { x: 2, y: 4, color: "#EF4444" }, { x: 3, y: 4, color: "#EF4444" }, { x: 4, y: 4, color: "#EF4444" },
            { x: 1, y: 5, color: "#EF4444" }, { x: 2, y: 5, color: "#EF4444" }, { x: 4, y: 5, color: "#EF4444" }, { x: 5, y: 5, color: "#EF4444" },
            { x: 0, y: 6, color: "#EF4444" }, { x: 1, y: 6, color: "#EF4444" }, { x: 5, y: 6, color: "#EF4444" }, { x: 6, y: 6, color: "#EF4444" },
        ])
    },
    {
        id: "icon_menu",
        ...
        height: 7,
        data: createGrid(7, 7, [
            { x: 0, y: 1, color: "#374151" }, { x: 1, y: 1, color: "#374151" }, { x: 2, y: 1, color: "#374151" }, { x: 3, y: 1, color: "#374151" }, { x: 4, y: 1, color: "#374151" }, { x: 5, y: 1, color: "#374151" }, { x: 6, y: 1, color: "#374151" },
            { x: 0, y: 3, color: "#374151" }, { x: 1, y: 3, color: "#374151" }, { x: 2, y: 3, color: "#374151" }, { x: 3, y: 3, color: "#374151" }, { x: 4, y: 3, color: "#374151" }, { x: 5, y: 3, color: "#374151" }, { x: 6, y: 3, color: "#374151" },
            { x: 0, y: 5, color: "#374151" }, { x: 1, y: 5, color: "#374151" }, { x: 2, y: 5, color: "#374151" }, { x: 3, y: 5, color: "#374151" }, { x: 4, y: 5, color: "#374151" }, { x: 5, y: 5, color: "#374151" }, { x: 6, y: 5, color: "#374151" },
        ])
    },
    {
        id: "icon_arrow_back",
        ...
        height: 7,
        data: createGrid(6, 7, [
            { x: 5, y: 0, color: "#1F2937" },
            { x: 4, y: 1, color: "#1F2937" }, { x: 5, y: 1, color: "#1F2937" },
            { x: 3, y: 2, color: "#1F2937" }, { x: 4, y: 2, color: "#1F2937" }, { x: 5, y: 2, color: "#1F2937" },
            { x: 0, y: 3, color: "#1F2937" }, { x: 1, y: 3, color: "#1F2937" }, { x: 2, y: 3, color: "#1F2937" }, { x: 3, y: 3, color: "#1F2937" }, { x: 4, y: 3, color: "#1F2937" }, { x: 5, y: 3, color: "#1F2937" },
            { x: 3, y: 4, color: "#1F2937" }, { x: 4, y: 4, color: "#1F2937" }, { x: 5, y: 4, color: "#1F2937" },
            { x: 4, y: 5, color: "#1F2937" }, { x: 5, y: 5, color: "#1F2937" },
            { x: 5, y: 6, color: "#1F2937" },
        ])
    },
    {
        id: "icon_arrow_fwd",
        ...
        height: 7,
        data: createGrid(6, 7, [
            { x: 0, y: 0, color: "#1F2937" },
            { x: 0, y: 1, color: "#1F2937" }, { x: 1, y: 1, color: "#1F2937" },
            { x: 0, y: 2, color: "#1F2937" }, { x: 1, y: 2, color: "#1F2937" }, { x: 2, y: 2, color: "#1F2937" },
            { x: 0, y: 3, color: "#1F2937" }, { x: 1, y: 3, color: "#1F2937" }, { x: 2, y: 3, color: "#1F2937" }, { x: 3, y: 3, color: "#1F2937" }, { x: 4, y: 3, color: "#1F2937" }, { x: 5, y: 3, color: "#1F2937" },
            { x: 0, y: 4, color: "#1F2937" }, { x: 1, y: 4, color: "#1F2937" }, { x: 2, y: 4, color: "#1F2937" },
            { x: 0, y: 5, color: "#1F2937" }, { x: 1, y: 5, color: "#1F2937" },
            { x: 0, y: 6, color: "#1F2937" },
        ])
    },
    {
        id: "icon_plus",
        ...
        data: createGrid(7, 7, [
            ...
            { x: 3, y: 1, color: "#3B82F6" },
            { x: 3, y: 2, color: "#3B82F6" },
            { x: 0, y: 3, color: "#3B82F6" }, { x: 1, y: 3, color: "#3B82F6" }, { x: 2, y: 3, color: "#3B82F6" }, { x: 3, y: 3, color: "#3B82F6" }, { x: 4, y: 3, color: "#3B82F6" }, { x: 5, y: 3, color: "#3B82F6" }, { x: 6, y: 3, color: "#3B82F6" },
            { x: 3, y: 4, color: "#3B82F6" },
            { x: 3, y: 5, color: "#3B82F6" },
            { x: 3, y: 6, color: "#3B82F6" },
        ])
    },
    {
        id: "icon_minus",
    ...
    },
    {
        ...
        height: 7,
        data: createGrid(7, 7, [
            { x: 1, y: 0, color: "#4B5563" }, { x: 3, y: 0, color: "#4B5563" }, { x: 5, y: 0, color: "#4B5563" },
            { x: 0, y: 1, color: "#4B5563" }, { x: 2, y: 1, color: "#4B5563" }, { x: 3, y: 1, color: "#4B5563" }, { x: 4, y: 1, color: "#4B5563" }, { x: 6, y: 1, color: "#4B5563" },
            { x: 1, y: 2, color: "#4B5563" }, { x: 2, y: 2, color: "#4B5563" }, { x: 4, y: 2, color: "#4B5563" }, { x: 5, y: 2, color: "#4B5563" },
            { x: 0, y: 3, color: "#4B5563" }, { x: 1, y: 3, color: "#4B5563" }, { x: 5, y: 3, color: "#4B5563" }, { x: 6, y: 3, color: "#4B5563" },
            { x: 1, y: 4, color: "#4B5563" }, { x: 2, y: 4, color: "#4B5563" }, { x: 4, y: 4, color: "#4B5563" }, { x: 5, y: 4, color: "#4B5563" },
            { x: 0, y: 5, color: "#4B5563" }, { x: 2, y: 5, color: "#4B5563" }, { x: 3, y: 5, color: "#4B5563" }, { x: 4, y: 5, color: "#4B5563" }, { x: 6, y: 5, color: "#4B5563" },
            { x: 1, y: 6, color: "#4B5563" }, { x: 3, y: 6, color: "#4B5563" }, { x: 5, y: 6, color: "#4B5563" },
        ])
    },
    {
        id: "icon_info",
        ...
        height: 7,
        data: createGrid(5, 7, [
            { x: 1, y: 0, color: "#3B82F6" }, { x: 2, y: 0, color: "#3B82F6" }, { x: 3, y: 0, color: "#3B82F6" },
            { x: 1, y: 1, color: "#3B82F6" }, { x: 2, y: 1, color: "#3B82F6" }, { x: 3, y: 1, color: "#3B82F6" },
            { x: 2, y: 3, color: "#3B82F6" },
            { x: 2, y: 4, color: "#3B82F6" },
            { x: 2, y: 5, color: "#3B82F6" },
            { x: 1, y: 6, color: "#3B82F6" }, { x: 2, y: 6, color: "#3B82F6" }, { x: 3, y: 6, color: "#3B82F6" },
        ])
    },
    {
        id: "icon_check",
        ...
        height: 7,
        data: createGrid(7, 7, [
            { x: 6, y: 0, color: "#10B981" },
            { x: 5, y: 1, color: "#10B981" }, { x: 6, y: 1, color: "#10B981" },
            { x: 4, y: 2, color: "#10B981" }, { x: 5, y: 2, color: "#10B981" },
            { x: 0, y: 3, color: "#10B981" }, { x: 3, y: 3, color: "#10B981" }, { x: 4, y: 3, color: "#10B981" },
            { x: 0, y: 4, color: "#10B981" }, { x: 1, y: 4, color: "#10B981" }, { x: 2, y: 4, color: "#10B981" }, { x: 3, y: 4, color: "#10B981" },
            { x: 1, y: 5, color: "#10B981" }, { x: 2, y: 5, color: "#10B981" },
        ])
    },
